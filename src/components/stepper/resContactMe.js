 ...
 function resContactMe() {
    ...
    <h2 className="name">Maria Marinescu</h2>
      ...
      <ul className="contact_information">
        ...
        <li className="resume"><a href="https://firebasestorage.googleapis.com/v0/b/my-journey-through-programming.appspot.com/o/resume.pdf?alt=media" target="_blank" rel="noopener noreferrer">download resume</a></li>
      </ul>
    </div>
