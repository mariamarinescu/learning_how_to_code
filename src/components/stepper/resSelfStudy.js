import React from 'react';
  ...
  function resSelfStudy() {
    return <div className="content1">
      <ul className="check">
        <li>
          I started to study between 7h - 10h/day on platforms as:
        ...
        <li>
          I started to learn modern technology stack, settled to use in the project:
            ...
            <li> Testing: Angular Component Testing, Protractor e2e Tests</li>
  
          </ul>
        </li>
        <hr />
        <li> After about 6 months of hard work I managed to have this: <br />
          <a href="https://alexandraciausu-a6df7.web.app/" target="_blank" rel="noopener norefferer" className="s">   Make-up Artist Portfolio Website - click me</a> <br />
